				    ...
				    <div class="tab1" style="padding-left:10px;">
						<form method="post" name="wp_manager">
							...
							<div class="questionCon" style="display:none;">
								...
								<div class="inputCon"><input type="checkbox" <?php echo $wpFastestCachePreload; ?> id="wpFastestCachePreload" name="wpFastestCachePreload"><label for="wpFastestCachePreload">Enable</label></div>
							</div>
